...
if __name__ == "__main__":
    ...
    response = agentLoader.send_message(expert_description)
    print(response)
  ...
  ##  communication_manager = CommunicationManager(rabbitmq_conn,)
    ## session = ExpertSession(agentLoader,cache_manager,communication_manager,expert_description)
